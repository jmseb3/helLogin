...
sourceSets {
    commonMain.dependencies {
        ...
        implementation("io.github.jmseb3:hellogin-core-ui") //core ui of library 
        implementation("io.github.jmseb3:hellogin-core-network") //core network of library  (for github)
